...
const Home = () => {
    ...
    return (
        <>
            ...
            <section className=" m-0 p-0 w-screen overflow-hidden h-screen flex flex-wrap items-center justify-center sm:h-auto ">
                <div className="w-[40%] truncate  h-[60%] bg-black sm:w-[100%]">
                    <img className="h-[100%] hover:scale-125 transition-all " src="mission.jpg" />
                </div>
                <div className="w-[40%] h-[80%] sm:w-[100%] sm:h-auto">
                    <div className="text-5xl tracking-widest mt-20 text-center  w-[100%]">Our Mission</div>
                    <div className="text-justify text-xl tracking-widest mt-10 pl-10 sm:w-[100%] sm:mt-5 sm:pl-1 sm:pr-1">
...
<br/>
            ...
            <section className="w-screen text-widest h-screen sm:h-auto ">
                <h1 className="text-5xl pl-10 sm:pl-0 sm:mb-4 sm:text-4xl">What We Offer ...</h1>
                <div className="flex justify-around w-screen h-screen sm:flex-col items-center sm:h-auto  ">
                    {
                        Cdata.map((elem, id) => {
                            return (

                                <div key={id} style={{ boxShadow: "-20px 22px 0px black", border: "2px solid grey" }} className="flex-col items-center w-[25%] h-[60%] sm:w-[80%] sm:mb-10 flex-wrap">
            ...
            <section className="flex w-screen flex-wrap text-widest h-auto mt-10 pl-20 pr-20 sm:pl-3 sm:pr-3 sm:h-auto">
                <div className="text-justify sm:text-center text-xl tracking-widest mt-10 w-[50%] sm:w-[100%]">
                ...
                <div className="w-[40%] rounded-full truncate m-auto bg-black h-96 sm:h-auto sm:mt-4 sm:w-[100%]">
